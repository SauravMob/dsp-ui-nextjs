...
export default async function page({
    ...
    return (
        <div>
            ...
            />
            <div className='mt-5'>
                <SiteappDatatable customFeatures={customFeatures} existingBids={existingBids} pageNo={parseInt(pageNo)} pageSize={parseInt(pageSize)} data={tabularData} reportType={reportType} />
            </div>
        </div>
    )
}
