...
import { updateCreative } from '@/app/(authenticated)/(assets)/creatives/actions'
...
import AttachCampaign from '../../campaigns/helpers/AttachCampaign'
...
export default function CreativeManagerDatatable({
    pageNo,
    pageSize,
    data
}: {
        ...
        return (
            <div className='px-20 m-1'>
                ...
                <div className='m-2'>
                    ...
                    <span className='ml-3'>{row.original.iabCategoryId || '-'}</span>
                </div>
                <div className='m-2'>
                    <span>Tracking Asset:</span>
                    <span className='ml-3'>{row.original.assetsPath}</span>
                </div>
                <div className='m-2'>
                    <span>Secure:</span>
