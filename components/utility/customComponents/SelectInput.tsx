    ...
    ({ className, options, value, id, isDisabled, ...props }, ref) => {
        return (
            <Select
                ...
                classNames={{
                    control: ({ isFocused }) => cn(isFocused ? "outline-none ring-2 ring-slate-950 ring-offset-2 dark:focus-visible:ring-slate-300" : "", "w-full ring-offset-white disabled:cursor-not-allowed disabled:opacity-50 rounded-md border border-slate-200 px-3 py-2 text-sm disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-8000 dark:bg-slate-950 select-option"),
    ...
    ({ className, options, value, isDisabled, id, formatOptionLabel, ...props }, ref) => {
        return (
            <Select
                ...
                value={value}
                classNames={{
                    control: ({ isFocused }) => cn(isFocused ? "outline-none ring-2 ring-slate-950 ring-offset-2 dark:focus-visible:ring-slate-300" : "", "w-full ring-offset-white disabled:cursor-not-allowed disabled:opacity-50 rounded-md border border-slate-200 px-3 py-2 text-sm disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-800 dark:bg-slate-950 select-option", isDisabled && "opacity-70"),
                    placeholder: () => "opacity-50",
                    menu: () => "p-50 mt-2 border border-slate-400 bg-white dark:bg-slate-900 rounded-lg z-10",
                    option: ({ isFocused }) => clsx(isFocused && "bg-slate-200 dark:bg-slate-700 active:bg-slate-400", "hover:cursor-pointer px-3 py-2 rounded select-option")
                }}
                classNamePrefix="select"
                options={options}
                isDisabled={isDisabled}
    ...
    ({ className, loadOptions, value, ...props }, ref) => {
        return (
            <AsyncSelect
                ...
                value={value}
                classNames={{
                    control: ({ isFocused }) => cn(isFocused ? "outline-none ring-2 ring-slate-950 ring-offset-2 dark:focus-visible:ring-slate-300" : "", "w-full ring-offset-white disabled:cursor-not-allowed disabled:opacity-50 rounded-md border border-slate-200 px-3 py-2 text-sm disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-800 dark:bg-slate-950 select-option"),
                    placeholder: () => "opacity-50",
                    menu: () => "p-50 mt-2 border border-slate-400 bg-white dark:bg-slate-900 rounded-lg",
                    option: ({ isFocused }) => clsx(isFocused && "bg-slate-200 dark:bg-slate-700 active:bg-slate-400", "hover:cursor-pointer px-3 py-2 rounded")
                }}
